...
module: htpasswd
version_added: "1.3"
short_description: manage user ansible_collection.dep_collection1.files for basic authentication
description:
...
extends_documentation_fragment: ansible_collection.dep_collection1.files
"""
